	...
	<div class="section-schedule">
		<div class="box box-solid wrap-box-post">
            <div class="box-header with-border section-head">
                <i class="fa fa-paper-plane text-blue"></i> <?=l('schedule-likes')?>
            </div>
        </div>
	                	...
	                	<div class="row">
						    <div class="row">
						    	<div class="form-group col-md-6 mb0">
							        <label class="head-title col-md-12 p0 fn"><i class="fa fa-clock-o"></i> <?=l('time-like')?></label>
		...
		<form class="formList">
			<div class="schedule-list-posts">
				<div class="schedule-title">
					<i class="fa fa-list-ol" aria-hidden="true"></i> <?=l('review-your-scheduled-like')?>
				</div>
				<div class="schedule-timeline">
					...
					<?php }?>
					<div class="item col-md-6" data-id="<?=$row->id?>">
						<div class="schedule-check col-md-2">
							<div class="box-icheck">
						...
						<div class="schedule-info col-md-8">
							<ul class="list-info">
								<li>
						...
						<div class="schedule-option col-md-2 pr0">
							<a class="btnActionItem" data-action="delete" data-toggle="tooltip" title="<?=l('')?>" href="javascript:void(0);"><i class="fa fa-times" aria-hidden="true"></i></a>
							<?php if($row->code != ""){?>
