	...
	<div class="section-schedule">
		<div class="box box-solid wrap-box-post">
            <div class="box-header with-border section-head">
                <i class="fa fa-paper-plane text-blue"></i> <?=l('schedule-unfollow')?>
                <div class="btn-group btn-group-xs right">
			        <a href="<?=PATH."instagram/follow/log?type=unfollow"?>" class="btn btn-warning"><i class="fa fa-history" aria-hidden="true"></i> <?=l('history')?></a>
			    </div>
            </div>
        </div>
		...
		<form class="formList">
			<div class="schedule-list-posts">
				<div class="schedule-title">
					<i class="fa fa-list-ol" aria-hidden="true"></i> <?=l('review-your-scheduled-unfollow')?>
				</div>
					...
					<div class="item" data-id="<?=$row->id?>">
						...
						<div class="schedule-info col-md-5 bl0">
							<ul class="list-info">
								...
								<li class="border-none"><i class="fa fa-arrow-circle-up" aria-hidden="true"></i> <?=l('maximum-unfollow')?>: <?=$row->maximum?></li>
							</ul>
						</div>
