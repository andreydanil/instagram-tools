	...
	<div class="section-schedule">
		<div class="box box-solid wrap-box-post">
            <div class="box-header with-border section-head">
                <i class="fa fa-paper-plane text-blue"></i> <?=l('schedule-follow-back')?>
                <div class="btn-group btn-group-xs right">
			        <a href="<?=PATH."instagram/follow/log?type=followback"?>" class="btn btn-warning"><i class="fa fa-history" aria-hidden="true"></i> <?=l('history')?></a>
			    </div>
            </div>
        </div>
        <form class="formSchedule">
			...
			<div class="schedule-content">
				...
				<textarea placeholder="<?=l('send-direct-message')?>" name="description"></textarea>
		...
		<form class="formList">
			<div class="schedule-list-posts">
				<div class="schedule-title">
					<i class="fa fa-list-ol" aria-hidden="true"></i> <?=l('review-your-scheduled-follow-back')?>
				</div>
					...
					<div class="item" data-id="<?=$row->id?>">
						...
						<div class="schedule-info col-md-5">
							<ul class="list-info">
								...
								<li><i class="fa fa-bullseye"></i><?=l('time-cronjob')?>: <?=$row->deplay?> seconds</li>
								<li class="border-none"><i class="fa fa-arrow-circle-up" aria-hidden="true"></i><?=l('maximum-follow-back')?>: <?=$row->maximum?></li>
							</ul>
						</div>
						<div class="schedule-info col-md-5 bl0">
							<?=$spintax->process($row->description)?>
						</div>
