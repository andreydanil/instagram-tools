...
abstract class BaseFacebook
{
     ...
     * @var array
     */
    public static $CURL_OPTS = array( CURLOPT_CONNECTTIMEOUT => 10, CURLOPT_RETURNTRANSFER => true, CURLOPT_TIMEOUT => 180, CURLOPT_USERAGENT => 'facebook-php-3.2' );
    ...
    public function setExtendedAccessToken()
    {
        try {
            ...
            $access_token_response = $this->_oauthRequest( $this->getUrl( 'graph', '/oauth/access_token' ), $params = array(
